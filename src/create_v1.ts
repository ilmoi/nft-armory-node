...
async function play() {
  const tokenMint = new PublicKey("3zLq4GrccYVAb9JqBQ8cVv3i17fvJo4YATa4i6b47mR3");
  const data = await prepNewMetadataData("https://ipfs.io/ipfs/QmNQh8noRHn7e7zt9oYNfGWuxHgKWkNPducMZs1SiZaYw4", new LocalWallet());
